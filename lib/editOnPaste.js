...
function editOnPaste(editor, e) {
  ...
  if (!editor.props.stripPastedStyles) {
    ...
    if (html) {
      var selection = editor._latestEditorState.getSelection();

      var contentState = editor._latestEditorState.getCurrentContent();

      var startBlock = contentState.getBlockForKey(selection.getStartKey());
      var isCodeBlock = (startBlock === null || startBlock === void 0 ? void 0 : startBlock.getType()) === 'code-block';
      var htmlFragment = DraftPasteProcessor.processHTML(html, editor.props.blockRenderMap, {
        isCodeBlock: isCodeBlock,
        customStyleMap: editor.props.customStyleMap
      });
        ...
        if (contentBlocks) {
          if (isCodeBlock) {
            ...
            contentBlocks = contentBlocks.map(function (block) {
              ...
              return block.merge({
                type: 'code-block',
                characterList: block.getCharacterList().map(function (c) {
