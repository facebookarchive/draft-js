...
var DraftEditorLeaf = /*#__PURE__*/function (_React$Component) {
  ...
  _proto._setSelection = function _setSelection() {
    ...
    var anchorNode = windowSelection.anchorNode;
    var newTargetNode = targetNode;
    ...
    var editorRoot = anchorNode.closest('.DraftEditor-root');
    var targetRoot = newTargetNode.closest('.DraftEditor-root');
  ...
  _proto.render = function render() {
    ...
    var className = styleSet.map(function (styleName) {
      return "style-".concat(styleName);
    }).join(' ');
