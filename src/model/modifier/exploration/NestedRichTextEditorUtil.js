 ...
 *
 * @providesModule NestedRichTextEditorUtil
 * @format
 * @flow
 *
...
// and/or a schema in conjuction to DraftBlockRenderMap
...
const NestedRichTextEditorUtil: RichTextUtils = {
  ...
  /**
   * Ensures that if on the begining of unstyled block and first child of
  ...
  onBackspace: (editorState: EditorState): ?EditorState => {
    ...
    // we want to delete that block completly
