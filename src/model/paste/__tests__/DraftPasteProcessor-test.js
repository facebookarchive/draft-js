...
describe('DraftPasteProcessor', function() {
  ...
  beforeEach(() => contentState = ContentState.createFromText(''));
  ...
  it('must identify italics text', function() {
    ...
    var {contentBlocks: output} = DraftPasteProcessor.processHTML(contentState, html, CUSTOM_BLOCK_MAP);
    var block = output[0];
  ...
  it('must preserve spaces', function() {
    ...
    output = DraftPasteProcessor.processHTML(contentState, html, CUSTOM_BLOCK_MAP);
  ...
  it('must split unstyled blocks on two br tags', function() {
    ...
    var output = DraftPasteProcessor.processHTML(contentState, html, CUSTOM_BLOCK_MAP);
  ...
  it('must detect links in pasted content', function() {
    ...
    } = DraftPasteProcessor.processHTML(contentState, html, CUSTOM_BLOCK_MAP);
    assertBlockTypes(output, ['unstyled']);
    assertEntities(
      output[0],
    ...
    var entity = newContentState.getEntity(entityId);
  ...
  it('Should detect when somthing is un-styled in a child', function() {
    ...
    let output = DraftPasteProcessor.processHTML(contentState, html, CUSTOM_BLOCK_MAP);
